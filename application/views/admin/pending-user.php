...
<div class="content">
 ...
 <img src="<?=base_url().'proofs/'.$users['pic1']?>" alt="img" class="img-responsive" h>           
...
<img src="<?=base_url().'proofs/'.$users['pic2']?>" alt="img" class="img-responsive">           
          ...
          <a href="<?php echo base_url() ?>admin/verify_user/<?php echo $users['user_id'] ?>" class="btn btn-primary">Verify User</a>
        </form>
